	...
	*/
	...
	if ( allocateCacheEntryCount > _totalAllocatedEntryCount) {
		...
		if(rightCaller==true && temp==true){
			...
			omrtty_printf("_tag_Successful\t CollectorExpanded:        %8u\t _incrementEntryCount :%8u\t allocateCacheEntryCount:%u\n",ext->_sizeExpandedBy_collectorExpanded,_incrementEntryCount,allocateCacheEntryCount);
		}	
		omrtty_printf(    "_tag_Updated\t totalAllocatedEntryCount: %8u\t _incrementEntryCount :%8u\t allocateCacheEntryCount:%u\n",_totalAllocatedEntryCount,_incrementEntryCount,allocateCacheEntryCount);
		return temp;
	}
	omrtty_printf(        "_tag_NoChange\t totalAllocatedEntryCount: %8u\t _incrementEntryCount :%8u\t allocateCacheEntryCount:%u\n",_totalAllocatedEntryCount,_incrementEntryCount,allocateCacheEntryCount);
